  ...
  return (
    <div className="w-64 bg-zinc-900 border-r border-zinc-800 h-screen flex flex-col">
      <div className="h-16 flex items-center px-6 border-b border-zinc-800">
        <Link href="/admin/dashboard" className="text-lg font-semibold text-pink-300">
          ADMIN CMS
        </Link>
      </div>
                ...
                <Link
                  ...
                  className={`flex items-center px-3 py-2 rounded-md transition-colors ${
                    isActive
                      ...
                      : 'text-zinc-400 hover:bg-zinc-800 hover:text-pink-300'
                  }`}
                >
      ...
      <div className="p-3 border-t border-zinc-800">
        <div className="space-y-1">
          <Link
            href="/"
            target="_blank"
            className="flex items-center px-3 py-2 text-sm text-zinc-400 hover:text-pink-300 hover:bg-zinc-800 rounded-md transition-colors"
          >
          ...
          <Link
            href="/admin/logout"
            className="flex items-center px-3 py-2 text-sm text-pink-400 hover:bg-zinc-800 hover:text-pink-300 rounded-md w-full text-left transition-colors"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 mr-3">
