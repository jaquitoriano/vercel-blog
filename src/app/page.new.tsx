...
export default async function Home() {
  ...
  return (
    <div>
      ...
      <div className="relative w-screen h-screen -mt-6 mb-16 overflow-hidden left-[50%] right-[50%] ml-[-50vw] mr-[-50vw]">
        {/* Video Background */}
        <video
          ...
          playsInline
        >
          <source src={settings.welcome_bg_video} type="video/mp4" />
        </video>
        
        {/* Overlay */}
        <div 
          className="absolute top-0 left-0 w-full h-full"
          style={{ backgroundColor: settings.welcome_bg_overlay }}
        />
